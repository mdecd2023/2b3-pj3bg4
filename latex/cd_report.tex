...
%=-------------作者簡介-----------------=%
	...
	\end{center}	
	\begin{figure}
	\includegraphics[width=1.25in]{41023219.jpg}  %作者照片
	\end{figure}
	\end{textblock}}
   ...
   \vspace{2em}
	...
	\begin{figure}
	\includegraphics[width=1.15in]{41023221.jpg}  %作者照片
    \end{figure}
    \end{textblock}}
...
\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{經歷}\enspace:\enspace
    ...
    \begin{figure}
        \includegraphics[width=1.15in]{41023222.jpg} %{}內是圖片文件的相對路徑
    \end{figure}
    \end{textblock}}
    {\renewcommand\baselinestretch{0.99}\selectfont %設定以下行距
...
\noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{經歷}\enspace:\enspace
   ...
   \vspace{2em}
    ...
    \begin{figure}
        \includegraphics[width=1.15in]{41023228.jpg} %{}內是圖片文件的相對路徑
    \end{figure}
    \end{textblock}}
    {\renewcommand\baselinestretch{0.99}\selectfont %設定以下行距
